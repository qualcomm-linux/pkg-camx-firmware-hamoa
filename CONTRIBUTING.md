# Contributing to pkg-camx-firmware-hamoa
...
1. [Fork](https://github.com/qualcomm-linux/pkg-template/fork) and clone the repository.
    ...
    ```bash
    git clone https://github.com/qualcomm-linux/pkg-camx-firmware-hamoa.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-camx-firmware-hamoa.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-camx-firmware-hamoa/pulls) from your branch to `qcom/debian/latest`.
